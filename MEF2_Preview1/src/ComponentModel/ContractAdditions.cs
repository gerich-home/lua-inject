...
{ 
    /// <summary>
    ///     Used to annotate methods as precondition checks for code contract tools.
    /// </summary>
    ...
    [ContractClassFor(typeof(ComposablePartCatalog))]
    internal abstract class ComposablePartCatalogContract : ComposablePartCatalog
    {
        public override IQueryable<ComposablePartDefinition> Parts
        {
            get
            {
                Contract.Ensures(Contract.Result<IQueryable<ComposablePartDefinition>>() != null);
                throw new NotImplementedException();
            }
        }
